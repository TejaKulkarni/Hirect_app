    ...
    <div>
        <div>
          <div className="title-area-bottom">
            ...
            <center>
            <img
              src="https://hirectapp.com/_nuxt/img/c44b25d.png"
              alt="title-img"
        ...
        <div className="form-area">
            ...
            <div className="get-hirect-app">
              ...
              <div className="get-hirect-display">
                <div className="QRcode-pic-container">
                  <center>
                    <img
                      src="https://hirectapp.com/_nuxt/img/2820a4c.png"
                      alt="qr"
                    ...
                    <div className="downloadDialog-button">
                      <button>
                        ...
                        >
                          <img
                            src="https://hirectapp.com/_nuxt/img/c35bf05.png"
                            alt="appstore"
                      ...
                      <button>
                        ...
                        >
                          <img
                            src="https://hirectapp.com/_nuxt/img/cb9308c.png"
                            alt="google"
                      ...
                      <div class="downloadDialog-button-pkg-container">
                        <button>
                          <a href="https://prod-apk-package.s3.ap-south-1.amazonaws.com/app-official-release.apk">
                            <img
                              src="	https://hirectapp.com/_nuxt/img/bebdb99.png"
          ...
          <div className="form-area-right">
            <center>
              ...
              <img
                src="https://hirectapp.com/_nuxt/img/cc0d921.png"
                alt="logos"
                class="form-area-img"
              />
            </center>
        ...
        <div className="download-step">
          <center>
            ...
            <img
              src="https://hirectapp.com/_nuxt/img/2e71c14.png"
              alt="download-step"
        ...
        <div className="seeking-candidate">
          <img
            src="https://hirectapp.com/_nuxt/img/96a89df.png"
            alt="staff"
